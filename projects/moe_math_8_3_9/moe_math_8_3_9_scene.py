...
class FactoringQuadraticTeaching(Scene):
    ...
    def construct(self):
        ...
        title_group = VGroup(title, credit).arrange(DOWN, aligned_edge=LEFT, buff=0.18)
        title_group.to_corner(UL, buff=0.45)
        ...
        rule.to_edge(RIGHT, buff=0.75).shift(UP * 0.9)
        ...
        number_demo.next_to(rule, DOWN, buff=0.55).align_to(rule, LEFT)
        ...
        example.to_edge(LEFT, buff=0.75).shift(UP * 0.45)
        ...
        solve.to_edge(RIGHT, buff=0.65).shift(DOWN * 0.25)
        ...
        check.to_edge(RIGHT, buff=0.55).shift(DOWN * 0.15)
        ...
        poly = self.make_text("x^2 + x - 2 = 0", size=36, color=WHITE)
        ...
        example2.to_edge(LEFT, buff=0.75).shift(UP * 0.3)
        cap = self.update_step(
            cap,
            durations[7],
        ...
        split2.to_edge(RIGHT, buff=0.85).shift(UP * 0.65)
        ...
        example3 = self.line_group(
            ["例題三：有公因式", "x^2 - 3x = 0", "x(x - 3) = 0"],
            size=34,
            colors=[YELLOW, WHITE, chalk_green],
            buff=0.25,
        )
        example3.to_edge(LEFT, buff=0.75).shift(UP * 0.35)
        ...
        solve3.to_edge(RIGHT, buff=0.75).shift(UP * 0.15)
        ...
        warning.to_edge(RIGHT, buff=0.7).shift(UP * 0.35)
        ...
        steps.to_edge(RIGHT, buff=0.75).shift(UP * 0.05)
        ...
        final.to_edge(RIGHT, buff=0.9).shift(UP * 0.15)
